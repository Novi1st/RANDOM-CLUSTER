...
<ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('user/home')?>">
        <div class="sidebar-brand-icon">
            <img class="w-100 h-100 p-0" src="<?= base_url('assets/img/logo/logo.png') ?>" alt="logo">
        </div>
        <!--<div class="sidebar-brand-text mx-3">Dewi Media Lestari</div>-->
    </a>
