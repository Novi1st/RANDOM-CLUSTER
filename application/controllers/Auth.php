...
/* Konstruktor Function */
    ...
    public function index() //method default
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'DML User Login';
            $this->load->view('templates/auth_header', $data); //memanggil templates header
            $this->load->view('auth/login'); //memanggil view login
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'DML User Registration';
            ...
            $data = [
                'name' => htmlspecialchars($this->input->post('name', true)), //true u/ menghindari cross side scripting
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $this->email->from('novinurkhaen.1@gmail.com', 'CV Dewi Media Lestari');
    ...
    public function forgotPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/auth_header', $data); //memanggil templates header
            $this->load->view('auth/forgot-password'); //memanggil view login
            $this->load->view('templates/auth_footer'); 
        } else {
            $email = $this->input->post('email');
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/auth_header', $data); //memanggil templates header
            $this->load->view('auth/change-password'); //memanggil view login
            $this->load->view('templates/auth_footer'); 
        } else {
            $password = password_hash($this->input->post('password1'), PASSWORD_DEFAULT);
